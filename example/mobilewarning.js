...
if (/Mobile|Android|iP(hone|od)|IEMobile|BlackBerry|Kindle|Silk-Accelerated|(hpw|web)OS|Opera M(obi|ini)/.test(ua)) {
    alert("It seems like you are using a mobile device. Please note, that this game doesn't work really good on mobile devices, but you can still try it. If you are not using a mobile device, just ignore this warning.")
